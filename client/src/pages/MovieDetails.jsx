...
const getShow =async()=>{
  ...
  return show ? (
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            bg-gray-800 hover:bg-gray-900 tansistion rounded-md font-medium
            ...
            <button className='bg-gray-700 p-2.5
      ...
      <p className='text-lg font-medium mt-30'>Your Favorite Cast</p>
     ...
     <div className='text-lg font-medium mt-20 mb-8'>You may also like</div>
